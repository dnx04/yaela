...
public class DictionaryManagement extends Dictionary {
    ...
    public static void dictionaryLookup() {
        ...
        System.out.println("CommandVersion.Word not found!");
        //
    ...
    public static void addWord() {
        ...
        System.out.println("CommandVersion.Word added!");
    ...
    public static void updateWord() {
        ...
        for (Word w : words) {
            if (w.getWordTarget().equals(updateWordTarget)) {
                ...
                System.out.println("CommandVersion.Word updated!");
    ...
    public static void deleteWord() {
        ...
        for (Word w : words) {
            if (w.getWordTarget().equals(deleteWordTarget)) {
                ...
                words.remove(w);
                System.out.println("CommandVersion.Word deleted!");

                s.close();
                return;
            }
        }
        System.out.println("CommandVersion.Word doesn't exist!");
        //
